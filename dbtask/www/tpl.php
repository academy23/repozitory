                        ...
                        <div class="container-fluid">
                            ...
                            <nav>
								<div class="nav-collapse">
									<ul class="nav">
										<li class="dropdown">
											<a data-toggle="dropdown" class="dropdown-toggle" href="/?action=listSubject">Предмети</a>
										</li>
										<li class="dropdown">
											<a data-toggle="dropdown" class="dropdown-toggle" href="/?action=listFaculty">Факультети</a>
										</li>
										<li class="dropdown">
											<a data-toggle="dropdown" class="dropdown-toggle" href="/?action=listLector">Лектори</a>
										</li>
										<li class="dropdown">
